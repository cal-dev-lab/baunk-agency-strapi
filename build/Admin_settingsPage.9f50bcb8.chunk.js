"use strict";
(globalThis["webpackChunkstrapicms"] = globalThis["webpackChunkstrapicms"] || []).push([[5895],{
...
const RolesCreatePage=(()=>{if(window&&window.strapi&&window.strapi.isEE){return (__webpack_require__(18290)/* ["default"] */ .Z);}return (__webpack_require__(56368)/* ["default"] */ .Z);})();const ProtectedRolesListPage=(()=>{if(window&&window.strapi&&window.strapi.isEE){return (__webpack_require__(28099)/* ["default"] */ .Z);}return (__webpack_require__(73044)/* ["default"] */ .Z);})();const defaultRoutes=[{Component:()=>{return{default:ProtectedRolesListPage};},to:'/settings/roles',exact:true},{Component:()=>{return{default:RolesCreatePage};},to:'/settings/roles/duplicate/:id',exact:true},{Component:()=>{return{default:RolesCreatePage};},to:'/settings/roles/new',exact:true},{Component:async()=>{const component=await __webpack_require__.e(/* import() | admin-edit-roles-page */ 2544).then(__webpack_require__.bind(__webpack_require__, 50287));return component;},to:'/settings/roles/:id',exact:true},{Component:async()=>{const component=await __webpack_require__.e(/* import() | admin-users */ 5199).then(__webpack_require__.bind(__webpack_require__, 61322));return component;},to:'/settings/users',exact:true},{Component:async()=>{const component=await __webpack_require__.e(/* import() | admin-edit-users */ 4263).then(__webpack_require__.bind(__webpack_require__, 86294));return component;},to:'/settings/users/:id',exact:true},{Component:async()=>{const component=await Promise.all(/* import() | webhook-edit-page */[__webpack_require__.e(8252), __webpack_require__.e(5162)]).then(__webpack_require__.bind(__webpack_require__, 2937));return component;},to:'/settings/webhooks/create',exact:true},{Component:async()=>{const component=await Promise.all(/* import() | webhook-edit-page */[__webpack_require__.e(8252), __webpack_require__.e(5162)]).then(__webpack_require__.bind(__webpack_require__, 27103));return component;},to:'/settings/webhooks/:id',exact:true},{Component:async()=>{const component=await __webpack_require__.e(/* import() | webhook-list-page */ 4121).then(__webpack_require__.bind(__webpack_require__, 77967));return component;},to:'/settings/webhooks',exact:true},{Component:async()=>{const component=await __webpack_require__.e(/* import() | api-tokens-list-page */ 8056).then(__webpack_require__.bind(__webpack_require__, 81666));return component;},to:'/settings/api-tokens',exact:true},{Component:async()=>{const component=await __webpack_require__.e(/* import() | api-tokens-create-page */ 4299).then(__webpack_require__.bind(__webpack_require__, 1424));return component;},to:'/settings/api-tokens/create',exact:true},{Component:async()=>{const component=await __webpack_require__.e(/* import() | api-tokens-edit-page */ 92).then(__webpack_require__.bind(__webpack_require__, 51037));return component;},to:'/settings/api-tokens/:id',exact:true}];/* harmony default export */ const utils_defaultRoutes = (defaultRoutes);
...
const customRoutes=(()=>{if(window&&window.strapi&&window.strapi.isEE){return (__webpack_require__(49475)/* ["default"] */ .Z);}return (__webpack_require__(73258)/* ["default"] */ .Z);})();/* harmony default export */ const routes = ([...customRoutes,...utils_defaultRoutes]);
...
const IS_DISABLED=(()=>{if(window&&window.strapi&&window.strapi.isEE){return (__webpack_require__(15272)/* ["default"] */ .Z);}return (__webpack_require__(14934)/* ["default"] */ .Z);})();const FlexWrapper=/*#__PURE__*/(0,styled_components_browser_cjs["default"])(Flex.Flex).withConfig({displayName:"ActionRow__FlexWrapper",componentId:"sc-1bqpgdl-0"})(["height:",";"],rowHeight);const ActionRow=_ref=>{let{arrayOfOptionsGroupedByCategory,isFormDisabled,isGrey,label,name,onChange,value}=_ref;const{formatMessage}=(0,react_intl.useIntl)();const options=arrayOfOptionsGroupedByCategory.reduce((arr,curr)=>{const[label,children]=curr;const obj={label:upperFirst_default()(label),children:children.map(child=>({label:child.displayName,value:child.id}))};return[...arr,obj];},[]);// Output: ['value1', 'value2']
const values=Object.values(value).map(x=>Object.entries(x).filter(_ref2=>{let[,value]=_ref2;return value;}).map(_ref3=>{let[key]=_ref3;return key;})).flat();// ! Only expects arrayOfOpt to be [['default', obj]] - might break in future changes
const handleChange=val=>{const[[,values]]=arrayOfOptionsGroupedByCategory;const formattedValues=values.reduce((acc,curr)=>({[curr.id]:val.includes(curr.id),...acc}),{});onChange(name,formattedValues);};return/*#__PURE__*/react.createElement(FlexWrapper,{as:"li",background:isGrey?'neutral100':'neutral0'},/*#__PURE__*/react.createElement(Flex.Flex,{paddingLeft:6,style:{width:180}},/*#__PURE__*/react.createElement(Typography.Typography,{variant:"sigma",textColor:"neutral600"},formatMessage({id:'Settings.permissions.conditions.can',defaultMessage:'Can'}),"\xA0"),/*#__PURE__*/react.createElement(Typography.Typography,{variant:"sigma",title:label,textColor:"primary600",ellipsis:true},formatMessage({id:`Settings.roles.form.permissions.${label.toLowerCase()}`,defaultMessage:label})),/*#__PURE__*/react.createElement(Typography.Typography,{variant:"sigma",textColor:"neutral600"},"\xA0",formatMessage({id:'Settings.permissions.conditions.when',defaultMessage:'When'}))),/*#__PURE__*/react.createElement(Box.Box,{style:{maxWidth:430,width:'100%'}},/*#__PURE__*/react.createElement(Select.MultiSelectNested,{id:name,customizeContent:values=>`${values.length} currently selected`,onChange:handleChange,value:values,options:options,disabled:isFormDisabled||IS_DISABLED})));};ActionRow.propTypes={arrayOfOptionsGroupedByCategory:(prop_types_default()).array.isRequired,isFormDisabled:(prop_types_default()).bool.isRequired,isGrey:(prop_types_default()).bool.isRequired,label:(prop_types_default()).string.isRequired,name:(prop_types_default()).string.isRequired,value:(prop_types_default()).object.isRequired,onChange:(prop_types_default()).func.isRequired};/* harmony default export */ const ConditionsModal_ActionRow = (ActionRow);
...
const Collapse_IS_DISABLED=(()=>{if(window&&window.strapi&&window.strapi.isEE){return (__webpack_require__(43549)/* ["default"] */ .Z);}return (__webpack_require__(55632)/* ["default"] */ .Z);})();const activeRowStyle=(theme,isActive)=>`
  ${Collapse_Wrapper} {
  ...
  &:focus-within {
    ${_ref=>{let{theme,isActive}=_ref;return activeRowStyle(theme,isActive);}}
  }
  
`;const Collapse_Wrapper=/*#__PURE__*/styled_components_browser_cjs["default"].div.withConfig({displayName:"Collapse__Wrapper",componentId:"sc-132fji1-0"})(["flex:1;display:flex;align-items:center;height:",";background-color:",";border:1px solid transparent;"],rowHeight,_ref2=>{let{isGrey,theme}=_ref2;return isGrey?theme.colors.neutral100:theme.colors.neutral0;});const BoxWrapper=/*#__PURE__*/styled_components_browser_cjs["default"].div.withConfig({displayName:"Collapse__BoxWrapper",componentId:"sc-132fji1-1"})(["display:inline-flex;min-width:100%;","{display:none;}"," &:hover{","}"],components_ConditionsButton,_ref3=>{let{isActive,theme}=_ref3;return isActive&&activeRowStyle(theme,isActive);},_ref4=>{let{theme,isActive}=_ref4;return activeRowStyle(theme,isActive);});const Cell=/*#__PURE__*/(0,styled_components_browser_cjs["default"])(Flex.Flex).withConfig({displayName:"Collapse__Cell",componentId:"sc-132fji1-2"})(["width:",";position:relative;"],cellWidth);const Chevron=/*#__PURE__*/(0,styled_components_browser_cjs["default"])(Box.Box).withConfig({displayName:"Collapse__Chevron",componentId:"sc-132fji1-3"})(["display:none;svg{width:11px;}*{fill:",";}"],_ref5=>{let{theme}=_ref5;return theme.colors.primary600;});const TinyDot=/*#__PURE__*/styled_components_browser_cjs["default"].span.withConfig({displayName:"Collapse__TinyDot",componentId:"sc-132fji1-4"})(["position:absolute;top:-6px;left:37px;width:6px;height:6px;border-radius:20px;background:",";"],_ref6=>{let{theme}=_ref6;return theme.colors.primary600;});const AbsoluteBox=/*#__PURE__*/(0,styled_components_browser_cjs["default"])(Box.Box).withConfig({displayName:"Collapse__AbsoluteBox",componentId:"sc-132fji1-5"})(["position:absolute;right:9px;transform:translateY(10px);"]);const Collapse=_ref7=>{let{availableActions,isActive,isGrey,isFormDisabled,label,onClickToggle,pathToData}=_ref7;const[isModalOpen,setModalOpen]=(0,react.useState)(false);const{formatMessage}=(0,react_intl.useIntl)();const{modifiedData,onChangeParentCheckbox,onChangeSimpleCheckbox}=(0,hooks/* usePermissionsDataManager */.$_)();const handleToggleModalIsOpen=()=>{setModalOpen(s=>!s);};const handleModalClose=()=>{setModalOpen(false);};// This corresponds to the data related to the CT left checkbox
// modifiedData: { collectionTypes: { [ctuid]: {create: {properties: { fields: {f1: true} }, update: {}, ... } } } }
const mainData=get_default()(modifiedData,pathToData.split('..'),{});// The utils we are using: getCheckboxState, retrieves all the boolean leafs of an object in order
...
const dataWithoutCondition=(0,react.useMemo)(()=>{return Object.keys(mainData).reduce((acc,current)=>{acc[current]=omit_default()(mainData[current],'conditions');return acc;},{});},[mainData]);const{hasAllActionsSelected,hasSomeActionsSelected}=utils_getCheckboxState(dataWithoutCondition);// Here we create an array of <checkbox>, since the state of each one of them is used in
// order to know if whether or not we need to display the associated action in
// the <ConditionsModal />
const checkboxesActions=(0,react.useMemo)(()=>{return utils_generateCheckboxesActions(availableActions,modifiedData,pathToData);},[availableActions,modifiedData,pathToData]);const doesConditionButtonHasConditions=checkboxesActions.some(_ref8=>{let{hasConditions}=_ref8;return hasConditions;});return/*#__PURE__*/react.createElement(BoxWrapper,{isActive:isActive},/*#__PURE__*/react.createElement(Collapse_Wrapper,{isGrey:isGrey},/*#__PURE__*/react.createElement(components_RowLabelWithCheckbox,{isCollapsable:true,isFormDisabled:isFormDisabled,label:label,checkboxName:pathToData,onChange:onChangeParentCheckbox,onClick:onClickToggle,someChecked:hasSomeActionsSelected,value:hasAllActionsSelected,isActive:isActive},/*#__PURE__*/react.createElement(Chevron,{paddingLeft:2},isActive?/*#__PURE__*/react.createElement((ChevronUp_default()),null):/*#__PURE__*/react.createElement((ChevronDown_default()),null))),/*#__PURE__*/react.createElement(Flex.Flex,{style:{flex:1}},checkboxesActions.map(_ref9=>{let{actionId,hasConditions,hasAllActionsSelected,hasSomeActionsSelected,isDisplayed,isParentCheckbox,checkboxName,label:permissionLabel}=_ref9;if(!isDisplayed){return/*#__PURE__*/react.createElement(components_HiddenAction,{key:actionId});}if(isParentCheckbox){return/*#__PURE__*/react.createElement(Cell,{key:actionId,justifyContent:"center",alignItems:"center"},hasConditions&&/*#__PURE__*/react.createElement(TinyDot,null),/*#__PURE__*/react.createElement(BaseCheckbox.BaseCheckbox,{disabled:isFormDisabled||Collapse_IS_DISABLED,name:checkboxName,"aria-label":formatMessage({id:`Settings.permissions.select-by-permission`,defaultMessage:'Select {label} permission'},{label:`${permissionLabel} ${label}`})// Keep same signature as packages/core/admin/admin/src/components/Roles/Permissions/index.js l.91
,onValueChange:value=>{onChangeParentCheckbox({target:{name:checkboxName,value}});},indeterminate:hasSomeActionsSelected,value:hasAllActionsSelected}));}return/*#__PURE__*/react.createElement(Cell,{key:actionId,justifyContent:"center",alignItems:"center"},hasConditions&&/*#__PURE__*/react.createElement(TinyDot,null),/*#__PURE__*/react.createElement(BaseCheckbox.BaseCheckbox,{disabled:isFormDisabled||Collapse_IS_DISABLED,indeterminate:hasConditions,name:checkboxName// Keep same signature as packages/core/admin/admin/src/components/Roles/Permissions/index.js l.91
,onValueChange:value=>{onChangeSimpleCheckbox({target:{name:checkboxName,value}});},value:hasAllActionsSelected}));})),isModalOpen&&/*#__PURE__*/react.createElement(components_ConditionsModal,{headerBreadCrumbs:[label,'app.components.LeftMenuLinkContainer.settings'],actions:checkboxesActions,isFormDisabled:isFormDisabled,onClosed:handleModalClose,onToggle:handleToggleModalIsOpen})),/*#__PURE__*/react.createElement(AbsoluteBox,null,/*#__PURE__*/react.createElement(components_ConditionsButton,{onClick:handleToggleModalIsOpen,hasConditions:doesConditionButtonHasConditions})));};Collapse.propTypes={availableActions:(prop_types_default()).array.isRequired,isActive:(prop_types_default()).bool.isRequired,isGrey:(prop_types_default()).bool.isRequired,isFormDisabled:(prop_types_default()).bool.isRequired,label:(prop_types_default()).string.isRequired,onClickToggle:(prop_types_default()).func.isRequired,pathToData:(prop_types_default()).string.isRequired};/* harmony default export */ const ContentTypeCollapse_Collapse = (Collapse);
...
const SubActionRow_IS_DISABLED=(()=>{if(window&&window.strapi&&window.strapi.isEE){return (__webpack_require__(73071)/* ["default"] */ .Z);}return (__webpack_require__(93485)/* ["default"] */ .Z);})();const SubActionRow_Cell=/*#__PURE__*/(0,styled_components_browser_cjs["default"])(Flex.Flex).withConfig({displayName:"SubActionRow__Cell",componentId:"sc-7y8yzq-0"})(["width:",";position:relative;"],cellWidth);const RowWrapper=/*#__PURE__*/(0,styled_components_browser_cjs["default"])(Flex.Flex).withConfig({displayName:"SubActionRow__RowWrapper",componentId:"sc-7y8yzq-1"})(["height:",";"],rowHeight);const SubActionRow_Wrapper=/*#__PURE__*/(0,styled_components_browser_cjs["default"])(Box.Box).withConfig({displayName:"SubActionRow__Wrapper",componentId:"sc-7y8yzq-2"})(["padding-left:","rem;"],31/16);const LeftBorderTimeline=/*#__PURE__*/(0,styled_components_browser_cjs["default"])(Box.Box).withConfig({displayName:"SubActionRow__LeftBorderTimeline",componentId:"sc-7y8yzq-3"})(["border-left:",";"],_ref=>{let{isVisible,theme}=_ref;return isVisible?`4px solid ${theme.colors.primary200}`:'4px solid transparent';});const RowStyle=/*#__PURE__*/(0,styled_components_browser_cjs["default"])(Flex.Flex).withConfig({displayName:"SubActionRow__RowStyle",componentId:"sc-7y8yzq-4"})(["padding-left:",";width:","px;"," ",";"],_ref2=>{let{theme}=_ref2;return theme.spaces[4];},_ref3=>{let{level}=_ref3;return 145-level*36;},_ref4=>{let{isCollapsable,theme}=_ref4;return isCollapsable&&`
      ${CollapsePropertyMatrix_CarretIcon} {
        display: block;
  ...
  `;},_ref5=>{let{isActive,theme}=_ref5;return isActive&&utils_activeStyle(theme);});const TopTimeline=/*#__PURE__*/styled_components_browser_cjs["default"].div.withConfig({displayName:"SubActionRow__TopTimeline",componentId:"sc-7y8yzq-5"})(["padding-top:",";margin-top:",";width:","rem;background-color:",";border-top-left-radius:2px;border-top-right-radius:2px;"],_ref6=>{let{theme}=_ref6;return theme.spaces[2];},_ref7=>{let{theme}=_ref7;return theme.spaces[2];},4/16,_ref8=>{let{theme}=_ref8;return theme.colors.primary200;});const SubActionRow=_ref9=>{let{childrenForm,isFormDisabled,recursiveLevel,pathToDataFromActionRow,propertyActions,parentName,propertyName}=_ref9;const{formatMessage}=(0,react_intl.useIntl)();const{modifiedData,onChangeParentCheckbox,onChangeSimpleCheckbox}=(0,hooks/* usePermissionsDataManager */.$_)();const[rowToOpen,setRowToOpen]=(0,react.useState)(null);const handleClickToggleSubLevel=name=>{setRowToOpen(prev=>{if(prev===name){return null;}return name;});};const displayedRecursiveChildren=(0,react.useMemo)(()=>{if(!rowToOpen){return null;}return childrenForm.find(_ref10=>{let{value}=_ref10;return value===rowToOpen;});},[rowToOpen,childrenForm]);return/*#__PURE__*/react.createElement(SubActionRow_Wrapper,null,/*#__PURE__*/react.createElement(TopTimeline,null),childrenForm.map((_ref11,index)=>{let{label,value,required,children:subChildrenForm}=_ref11;const isVisible=index+1<childrenForm.length;const isArrayType=Array.isArray(subChildrenForm);const isActive=rowToOpen===value;return/*#__PURE__*/react.createElement(LeftBorderTimeline,{key:value,isVisible:isVisible},/*#__PURE__*/react.createElement(RowWrapper,null,/*#__PURE__*/react.createElement(components_Curve,{color:"primary200"}),/*#__PURE__*/react.createElement(Flex.Flex,{style:{flex:1}},/*#__PURE__*/react.createElement(RowStyle,{level:recursiveLevel,isActive:isActive,isCollapsable:isArrayType},/*#__PURE__*/react.createElement(components_CollapseLabel,(0,esm_extends/* default */.Z)({alignItems:"center",isCollapsable:isArrayType},isArrayType&&{onClick:()=>handleClickToggleSubLevel(value),'aria-expanded':isActive,onKeyDown:_ref12=>{let{key}=_ref12;return(key==='Enter'||key===' ')&&handleClickToggleSubLevel(value);},tabIndex:0,role:'button'},{title:label}),/*#__PURE__*/react.createElement(Typography.Typography,{ellipsis:true},upperFirst_default()(label)),required&&/*#__PURE__*/react.createElement(components_RequiredSign,null),/*#__PURE__*/react.createElement(CollapsePropertyMatrix_CarretIcon,{$isActive:isActive}))),/*#__PURE__*/react.createElement(Flex.Flex,{style:{flex:1}},propertyActions.map(_ref13=>{let{actionId,label:propertyLabel,isActionRelatedToCurrentProperty}=_ref13;if(!isActionRelatedToCurrentProperty){return/*#__PURE__*/react.createElement(components_HiddenAction,{key:actionId});}/*
                       ...
                       */const checkboxName=[...pathToDataFromActionRow.split('..'),actionId,'properties',propertyName,...parentName.split('..'),value];const checkboxValue=get_default()(modifiedData,checkboxName,false);if(!subChildrenForm){return/*#__PURE__*/react.createElement(SubActionRow_Cell,{key:propertyLabel,justifyContent:"center",alignItems:"center"},/*#__PURE__*/react.createElement(BaseCheckbox.BaseCheckbox,{disabled:isFormDisabled||SubActionRow_IS_DISABLED,name:checkboxName.join('..'),"aria-label":formatMessage({id:`Settings.permissions.select-by-permission`,defaultMessage:'Select {label} permission'},{label:`${parentName} ${label} ${propertyLabel}`})// Keep same signature as packages/core/admin/admin/src/components/Roles/Permissions/index.js l.91
,onValueChange:value=>{onChangeSimpleCheckbox({target:{name:checkboxName.join('..'),value}});},value:checkboxValue}));}const{hasAllActionsSelected,hasSomeActionsSelected}=utils_getCheckboxState(checkboxValue);return/*#__PURE__*/react.createElement(SubActionRow_Cell,{key:propertyLabel,justifyContent:"center",alignItems:"center"},/*#__PURE__*/react.createElement(BaseCheckbox.BaseCheckbox,{key:propertyLabel,disabled:isFormDisabled||SubActionRow_IS_DISABLED,name:checkboxName.join('..'),"aria-label":formatMessage({id:`Settings.permissions.select-by-permission`,defaultMessage:'Select {label} permission'},{label:`${parentName} ${label} ${propertyLabel}`})// Keep same signature as packages/core/admin/admin/src/components/Roles/Permissions/index.js l.91
,onValueChange:value=>{onChangeParentCheckbox({target:{name:checkboxName.join('..'),value}});},value:hasAllActionsSelected,indeterminate:hasSomeActionsSelected}));})))),displayedRecursiveChildren&&isActive&&/*#__PURE__*/react.createElement(Box.Box,{paddingBottom:2},/*#__PURE__*/react.createElement(SubActionRow,{isFormDisabled:isFormDisabled,parentName:`${parentName}..${value}`,pathToDataFromActionRow:pathToDataFromActionRow,propertyActions:propertyActions,propertyName:propertyName,recursiveLevel:recursiveLevel+1,childrenForm:displayedRecursiveChildren.children})));}));};SubActionRow.propTypes={childrenForm:(prop_types_default()).array.isRequired,isFormDisabled:(prop_types_default()).bool.isRequired,parentName:(prop_types_default()).string.isRequired,pathToDataFromActionRow:(prop_types_default()).string.isRequired,propertyActions:(prop_types_default()).array.isRequired,propertyName:(prop_types_default()).string.isRequired,recursiveLevel:(prop_types_default()).number.isRequired};/* harmony default export */ const CollapsePropertyMatrix_SubActionRow = (/*#__PURE__*/(0,react.memo)(SubActionRow));
...
const ActionRow_IS_DISABLED=(()=>{if(window&&window.strapi&&window.strapi.isEE){return (__webpack_require__(57779)/* ["default"] */ .Z);}return (__webpack_require__(48496)/* ["default"] */ .Z);})();const ActionRow_Cell=/*#__PURE__*/(0,styled_components_browser_cjs["default"])(Flex.Flex).withConfig({displayName:"ActionRow__Cell",componentId:"sc-4agenc-0"})(["width:",";position:relative;"],cellWidth);const ActionRow_Wrapper=/*#__PURE__*/(0,styled_components_browser_cjs["default"])(Flex.Flex).withConfig({displayName:"ActionRow__Wrapper",componentId:"sc-4agenc-1"})(["height:",";flex:1;"," ",";"],rowHeight,_ref=>{let{isCollapsable,theme}=_ref;return isCollapsable&&`
      ${CollapsePropertyMatrix_CarretIcon} {
        display: block;
        color: ${theme.colors.neutral100};
      }
  ...
  `;},_ref2=>{let{isActive,theme}=_ref2;return isActive&&utils_activeStyle(theme);});const ActionRow_ActionRow=_ref3=>{let{childrenForm,label,isFormDisabled,name,required,pathToData,propertyActions,propertyName,isOdd}=_ref3;const{formatMessage}=(0,react_intl.useIntl)();const[rowToOpen,setRowToOpen]=(0,react.useState)(null);const{modifiedData,onChangeCollectionTypeLeftActionRowCheckbox,onChangeParentCheckbox,onChangeSimpleCheckbox}=(0,hooks/* usePermissionsDataManager */.$_)();const isActive=rowToOpen===name;const recursiveChildren=(0,react.useMemo)(()=>{if(!Array.isArray(childrenForm)){return[];}return childrenForm;},[childrenForm]);const isCollapsable=recursiveChildren.length>0;const handleClick=(0,react.useCallback)(()=>{if(isCollapsable){setRowToOpen(prev=>{if(prev===name){return null;}return name;});}},[isCollapsable,name]);const handleChangeLeftRowCheckbox=_ref4=>{let{target:{value}}=_ref4;onChangeCollectionTypeLeftActionRowCheckbox(pathToData,propertyName,name,value);};const{hasAllActionsSelected,hasSomeActionsSelected}=(0,react.useMemo)(()=>{return utils_getRowLabelCheckboxeState(propertyActions,modifiedData,pathToData,propertyName,name);},[propertyActions,modifiedData,pathToData,propertyName,name]);return/*#__PURE__*/react.createElement(react.Fragment,null,/*#__PURE__*/react.createElement(ActionRow_Wrapper,{alignItems:"center",isCollapsable:isCollapsable,isActive:isActive,background:isOdd?'neutral100':'neutral0'},/*#__PURE__*/react.createElement(Flex.Flex,null,/*#__PURE__*/react.createElement(components_RowLabelWithCheckbox,{onChange:handleChangeLeftRowCheckbox,onClick:handleClick,isCollapsable:isCollapsable,isFormDisabled:isFormDisabled,label:label,someChecked:hasSomeActionsSelected,value:hasAllActionsSelected,isActive:isActive},required&&/*#__PURE__*/react.createElement(components_RequiredSign,null),/*#__PURE__*/react.createElement(CollapsePropertyMatrix_CarretIcon,{$isActive:isActive})),/*#__PURE__*/react.createElement(Flex.Flex,null,propertyActions.map(_ref5=>{let{label,isActionRelatedToCurrentProperty,actionId}=_ref5;if(!isActionRelatedToCurrentProperty){return/*#__PURE__*/react.createElement(components_HiddenAction,{key:label});}const checkboxName=[...pathToData.split('..'),actionId,'properties',propertyName,name];if(!isCollapsable){const checkboxValue=get_default()(modifiedData,checkboxName,false);return/*#__PURE__*/react.createElement(ActionRow_Cell,{key:actionId,justifyContent:"center",alignItems:"center"},/*#__PURE__*/react.createElement(BaseCheckbox.BaseCheckbox,{disabled:isFormDisabled||ActionRow_IS_DISABLED,name:checkboxName.join('..'),"aria-label":formatMessage({id:`Settings.permissions.select-by-permission`,defaultMessage:'Select {label} permission'},{label:`${name} ${label}`})// Keep same signature as packages/core/admin/admin/src/components/Roles/Permissions/index.js l.91
,onValueChange:value=>{onChangeSimpleCheckbox({target:{name:checkboxName.join('..'),value}});},value:checkboxValue}));}const data=get_default()(modifiedData,checkboxName,{});const{hasAllActionsSelected,hasSomeActionsSelected}=utils_getCheckboxState(data);return/*#__PURE__*/react.createElement(ActionRow_Cell,{key:label,justifyContent:"center",alignItems:"center"},/*#__PURE__*/react.createElement(BaseCheckbox.BaseCheckbox,{disabled:isFormDisabled||ActionRow_IS_DISABLED,name:checkboxName.join('..')// Keep same signature as packages/core/admin/admin/src/components/Roles/Permissions/index.js l.91
,onValueChange:value=>{onChangeParentCheckbox({target:{name:checkboxName.join('..'),value}});},"aria-label":formatMessage({id:`Settings.permissions.select-by-permission`,defaultMessage:'Select {label} permission'},{label:`${name} ${label}`}),value:hasAllActionsSelected,indeterminate:hasSomeActionsSelected}));})))),isActive&&/*#__PURE__*/react.createElement(CollapsePropertyMatrix_SubActionRow,{childrenForm:recursiveChildren,isFormDisabled:isFormDisabled,parentName:name,pathToDataFromActionRow:pathToData,propertyName:propertyName,propertyActions:propertyActions,recursiveLevel:0}));};ActionRow_ActionRow.defaultProps={childrenForm:[],required:false};ActionRow_ActionRow.propTypes={childrenForm:(prop_types_default()).array,label:(prop_types_default()).string.isRequired,isFormDisabled:(prop_types_default()).bool.isRequired,name:(prop_types_default()).string.isRequired,pathToData:(prop_types_default()).string.isRequired,propertyActions:(prop_types_default()).array.isRequired,propertyName:(prop_types_default()).string.isRequired,required:(prop_types_default()).bool,isOdd:(prop_types_default()).bool.isRequired};/* harmony default export */ const CollapsePropertyMatrix_ActionRow = (/*#__PURE__*/(0,react.memo)(ActionRow_ActionRow));
...
const GlobalActions_IS_DISABLED=(()=>{if(window&&window.strapi&&window.strapi.isEE){return (__webpack_require__(26107)/* ["default"] */ .Z);}return (__webpack_require__(39672)/* ["default"] */ .Z);})();const CenteredStack=/*#__PURE__*/(0,styled_components_browser_cjs["default"])(Stack.Stack).withConfig({displayName:"GlobalActions__CenteredStack",componentId:"sc-1vxwsjr-0"})(["align-items:center;justify-content:center;width:",";flex-shrink:0;"],cellWidth);const GlobalActions=_ref=>{let{actions,isFormDisabled,kind}=_ref;const{formatMessage}=(0,react_intl.useIntl)();const{modifiedData,onChangeCollectionTypeGlobalActionCheckbox}=(0,hooks/* usePermissionsDataManager */.$_)();const displayedActions=(0,react.useMemo)(()=>{return utils_findDisplayedActions(actions);},[actions]);const checkboxesState=(0,react.useMemo)(()=>{return getRowLabelCheckboxesState(displayedActions,modifiedData[kind]);},[modifiedData,displayedActions,kind]);return/*#__PURE__*/react.createElement(Box.Box,{paddingBottom:4,paddingTop:6,style:{paddingLeft:firstRowWidth}},/*#__PURE__*/react.createElement(Stack.Stack,{horizontal:true,spacing:0},displayedActions.map(_ref2=>{let{label,actionId}=_ref2;return/*#__PURE__*/react.createElement(CenteredStack,{key:actionId,spacing:3},/*#__PURE__*/react.createElement(Typography.Typography,{variant:"sigma",textColor:"neutral500"},formatMessage({id:`Settings.roles.form.permissions.${label.toLowerCase()}`,defaultMessage:label})),/*#__PURE__*/react.createElement(BaseCheckbox.BaseCheckbox,{disabled:isFormDisabled||GlobalActions_IS_DISABLED,onValueChange:value=>{onChangeCollectionTypeGlobalActionCheckbox(kind,actionId,value);},name:actionId,"aria-label":formatMessage({id:`Settings.permissions.select-all-by-permission`,defaultMessage:'Select all {label} permissions'},{label:formatMessage({id:`Settings.roles.form.permissions.${label.toLowerCase()}`,defaultMessage:label})}),value:get_default()(checkboxesState,[actionId,'hasAllActionsSelected'],false),indeterminate:get_default()(checkboxesState,[actionId,'hasSomeActionsSelected'],false)}));})));};GlobalActions.defaultProps={actions:[]};GlobalActions.propTypes={actions:prop_types_default().arrayOf(prop_types_default().shape({label:(prop_types_default()).string.isRequired,actionId:(prop_types_default()).string.isRequired,subjects:(prop_types_default()).array.isRequired})),isFormDisabled:(prop_types_default()).bool.isRequired,kind:(prop_types_default()).string.isRequired};/* harmony default export */ const components_GlobalActions = (/*#__PURE__*/(0,react.memo)(GlobalActions));
...
const SubCategory_IS_DISABLED=(()=>{if(window&&window.strapi&&window.strapi.isEE){return (__webpack_require__(45667)/* ["default"] */ .Z);}return (__webpack_require__(99399)/* ["default"] */ .Z);})();const Border=/*#__PURE__*/styled_components_browser_cjs["default"].div.withConfig({displayName:"SubCategory__Border",componentId:"sc-akgczm-0"})(["flex:1;align-self:center;border-top:1px solid ",";"],_ref=>{let{theme}=_ref;return theme.colors.neutral150;});const CheckboxWrapper=/*#__PURE__*/styled_components_browser_cjs["default"].div.withConfig({displayName:"SubCategory__CheckboxWrapper",componentId:"sc-akgczm-1"})(["position:relative;word-break:keep-all;",""],_ref2=>{let{hasConditions,disabled,theme}=_ref2;return hasConditions&&`
    &:before {
      content: '';
      position: absolute;
      top: ${-4/16}rem;
