"use strict";
(globalThis["webpackChunkstrapicms"] = globalThis["webpackChunkstrapicms"] || []).push([[4263],{
...
const MagicLink=(()=>{if(window&&window.strapi&&window.strapi.isEE){return (__webpack_require__(77791)/* ["default"] */ .Z);}return (__webpack_require__(26010)/* ["default"] */ .Z);})();const fieldsToPick=['email','firstname','lastname','username','isActive','roles'];const EditPage=_ref=>{let{canUpdate}=_ref;const{formatMessage}=(0,react_intl.useIntl)();const{params:{id}}=(0,react_router_dom_min.useRouteMatch)('/settings/users/:id');const{push}=(0,react_router_dom_min.useHistory)();const{setUserDisplayName}=(0,build.useAppInfos)();const toggleNotification=(0,build.useNotification)();const{lockApp,unlockApp}=(0,build.useOverlayBlocker)();(0,build.useFocusWhenNavigate)();const{status,data}=(0,lib.useQuery)(['user',id],()=>fetchUser(id),{retry:false,keepPreviousData:false,staleTime:1000*20,onError:err=>{const status=err.response.status;// Redirect the use to the homepage if is not allowed to read
if(status===403){toggleNotification({type:'info',message:{id:'notification.permission.not-allowed-read',defaultMessage:'You are not allowed to see this document'}});push('/');}console.log(err.response.status);}});const handleSubmit=async(body,actions)=>{lockApp();try{const data=await putUser(id,omit_default()(body,'confirmPassword'));toggleNotification({type:'success',message:formatMessage({id:'notification.success.saved',defaultMessage:'Saved'})});const userInfos=build.auth.getUserInfo();// The user is updating himself
if(id.toString()===userInfos.id.toString()){build.auth.setUserInfo(data);const userDisplayName=get_default()(body,'username')||(0,utils/* getFullName */.Pp)(body.firstname,body.lastname);setUserDisplayName(userDisplayName);}actions.setValues(pick_default()(body,fieldsToPick));}catch(err){// FIXME when API errors are ready
const errors=(0,utils/* formatAPIErrors */.Iz)(err.response.data);const fieldsErrors=Object.keys(errors).reduce((acc,current)=>{acc[current]=errors[current].id;return acc;},{});actions.setErrors(fieldsErrors);toggleNotification({type:'warning',message:get_default()(err,'response.data.message','notification.error')});}unlockApp();};const isLoading=status!=='success';const headerLabel=isLoading?{id:'app.containers.Users.EditPage.header.label-loading',defaultMessage:'Edit user'}:{id:'app.containers.Users.EditPage.header.label',defaultMessage:'Edit {name}'};const initialData=Object.keys(pick_default()(data,fieldsToPick)).reduce((acc,current)=>{if(current==='roles'){acc[current]=(data?.roles||[]).map(_ref2=>{let{id}=_ref2;return id;});return acc;}acc[current]=data?.[current];return acc;},{});const headerLabelName=initialData.username||(0,utils/* getFullName */.Pp)(initialData.firstname,initialData.lastname);const title=formatMessage(headerLabel,{name:headerLabelName});if(isLoading){return/*#__PURE__*/react.createElement(Main.Main,{"aria-busy":"true"},/*#__PURE__*/react.createElement(build.SettingsPageTitle,{name:"Users"}),/*#__PURE__*/react.createElement(Layout.HeaderLayout,{primaryAction:/*#__PURE__*/react.createElement(Button.Button,{disabled:true,startIcon:/*#__PURE__*/react.createElement((Check_default()),null),type:"button",size:"L"},formatMessage({id:'global.save',defaultMessage:'Save'})),title:title,navigationAction:/*#__PURE__*/react.createElement(build.Link,{startIcon:/*#__PURE__*/react.createElement((ArrowLeft_default()),null),to:"/settings/users?pageSize=10&page=1&sort=firstname"},formatMessage({id:'global.back',defaultMessage:'Back'}))}),/*#__PURE__*/react.createElement(Layout.ContentLayout,null,/*#__PURE__*/react.createElement(build.LoadingIndicatorPage,null)));}return/*#__PURE__*/react.createElement(Main.Main,null,/*#__PURE__*/react.createElement(build.SettingsPageTitle,{name:"Users"}),/*#__PURE__*/react.createElement(dist.Formik,{onSubmit:handleSubmit,initialValues:initialData,validateOnChange:false,validationSchema:users/* editValidation */.YM},_ref3=>{let{errors,values,handleChange,isSubmitting}=_ref3;return/*#__PURE__*/react.createElement(build.Form,null,/*#__PURE__*/react.createElement(Layout.HeaderLayout,{primaryAction:/*#__PURE__*/react.createElement(Button.Button,{disabled:isSubmitting||!canUpdate,startIcon:/*#__PURE__*/react.createElement((Check_default()),null),loading:isSubmitting,type:"submit",size:"L"},formatMessage({id:'global.save',defaultMessage:'Save'})),title:title,navigationAction:/*#__PURE__*/react.createElement(build.Link,{startIcon:/*#__PURE__*/react.createElement((ArrowLeft_default()),null),to:"/settings/users?pageSize=10&page=1&sort=firstname"},formatMessage({id:'global.back',defaultMessage:'Back'}))}),/*#__PURE__*/react.createElement(Layout.ContentLayout,null,data?.registrationToken&&/*#__PURE__*/react.createElement(Box.Box,{paddingBottom:6},/*#__PURE__*/react.createElement(MagicLink,{registrationToken:data.registrationToken})),/*#__PURE__*/react.createElement(Stack.Stack,{spacing:7},/*#__PURE__*/react.createElement(Box.Box,{background:"neutral0",hasRadius:true,shadow:"filterShadow",paddingTop:6,paddingBottom:6,paddingLeft:7,paddingRight:7},/*#__PURE__*/react.createElement(Stack.Stack,{spacing:4},/*#__PURE__*/react.createElement(Typography.Typography,{variant:"delta",as:"h2"},formatMessage({id:'app.components.Users.ModalCreateBody.block-title.details',defaultMessage:'Details'})),/*#__PURE__*/react.createElement(Grid.Grid,{gap:5},utils_layout.map(row=>{return row.map(input=>{return/*#__PURE__*/react.createElement(Grid.GridItem,(0,esm_extends/* default */.Z)({key:input.name},input.size),/*#__PURE__*/react.createElement(build.GenericInput,(0,esm_extends/* default */.Z)({},input,{disabled:!canUpdate,error:errors[input.name],onChange:handleChange,value:values[input.name]||''})));});})))),/*#__PURE__*/react.createElement(Box.Box,{background:"neutral0",hasRadius:true,shadow:"filterShadow",paddingTop:6,paddingBottom:6,paddingLeft:7,paddingRight:7},/*#__PURE__*/react.createElement(Stack.Stack,{spacing:4},/*#__PURE__*/react.createElement(Typography.Typography,{variant:"delta",as:"h2"},formatMessage({id:'global.roles',defaultMessage:"User's role"})),/*#__PURE__*/react.createElement(Grid.Grid,{gap:5},/*#__PURE__*/react.createElement(Grid.GridItem,{col:6,xs:12},/*#__PURE__*/react.createElement(SelectRoles/* default */.Z,{disabled:!canUpdate,error:errors.roles,onChange:handleChange,value:values.roles}))))))));}));};EditPage.propTypes={canUpdate:(prop_types_default()).bool.isRequired};/* harmony default export */ const Users_EditPage = (EditPage);
