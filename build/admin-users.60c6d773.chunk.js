(globalThis["webpackChunkstrapicms"] = globalThis["webpackChunkstrapicms"] || []).push([[5199],{
...
const formDataModel=(()=>{if(window&&window.strapi&&window.strapi.isEE){return (__webpack_require__(58818)/* ["default"] */ .Z);}return (__webpack_require__(79313)/* ["default"] */ .Z);})();const roleSettingsForm=(()=>{if(window&&window.strapi&&window.strapi.isEE){return (__webpack_require__(81003)/* ["default"] */ .Z);}return (__webpack_require__(91972)/* ["default"] */ .Z);})();const MagicLink=(()=>{if(window&&window.strapi&&window.strapi.isEE){return (__webpack_require__(77791)/* ["default"] */ .Z);}return (__webpack_require__(26010)/* ["default"] */ .Z);})();const ModalForm=_ref=>{let{queryName,onToggle}=_ref;const[currentStep,setStep]=(0,react.useState)('create');const[isSubmitting,setIsSubmitting]=(0,react.useState)(false);const[registrationToken,setRegistrationToken]=(0,react.useState)(null);const queryClient=(0,lib.useQueryClient)();const{formatMessage}=(0,react_intl.useIntl)();const toggleNotification=(0,build.useNotification)();const{lockApp,unlockApp}=(0,build.useOverlayBlocker)();const postMutation=(0,lib.useMutation)(body=>core_utils/* axiosInstance.post */.be.post('/admin/users',body),{onSuccess:async _ref2=>{let{data}=_ref2;setRegistrationToken(data.data.registrationToken);await queryClient.invalidateQueries(queryName);goNext();setIsSubmitting(false);},onError:err=>{setIsSubmitting(false);toggleNotification({type:'warning',message:{id:'notification.error',defaultMessage:'An error occured'}});throw err;},onSettled:()=>{unlockApp();}});const headerTitle=formatMessage({id:'Settings.permissions.users.create',defaultMessage:'Invite new user'});const handleSubmit=async(body,_ref3)=>{let{setErrors}=_ref3;lockApp();setIsSubmitting(true);try{await postMutation.mutateAsync(body);}catch(err){unlockApp();if(err?.response?.data.message==='Email already taken'){setErrors({email:err.response.data.message});}}};const goNext=()=>{if(next){setStep(next);}else{onToggle();}};const{buttonSubmitLabel,isDisabled,next}=utils_stepper[currentStep];const endActions=currentStep==='create'?/*#__PURE__*/react.createElement(Button.Button,{type:"submit",loading:isSubmitting},formatMessage(buttonSubmitLabel)):/*#__PURE__*/react.createElement(Button.Button,{type:"button",loading:isSubmitting,onClick:onToggle},formatMessage(buttonSubmitLabel));return/*#__PURE__*/react.createElement(ModalLayout.ModalLayout,{onClose:onToggle,labelledBy:"title"},/*#__PURE__*/react.createElement(ModalLayout.ModalHeader,null,/*#__PURE__*/react.createElement(Breadcrumbs.Breadcrumbs,{label:headerTitle},/*#__PURE__*/react.createElement(Breadcrumbs.Crumb,null,headerTitle))),/*#__PURE__*/react.createElement(dist.Formik,{initialValues:formDataModel,onSubmit:handleSubmit,validationSchema:utils_schema,validateOnChange:false},_ref4=>{let{errors,handleChange,values}=_ref4;return/*#__PURE__*/react.createElement(build.Form,null,/*#__PURE__*/react.createElement(ModalLayout.ModalBody,null,/*#__PURE__*/react.createElement(Stack.Stack,{spacing:6},currentStep!=='create'&&/*#__PURE__*/react.createElement(MagicLink,{registrationToken:registrationToken}),/*#__PURE__*/react.createElement(Box.Box,null,/*#__PURE__*/react.createElement(Typography.Typography,{variant:"beta",as:"h2"},formatMessage({id:'app.components.Users.ModalCreateBody.block-title.details',defaultMessage:'User details'})),/*#__PURE__*/react.createElement(Box.Box,{paddingTop:4},/*#__PURE__*/react.createElement(Stack.Stack,{spacing:1},/*#__PURE__*/react.createElement(Grid.Grid,{gap:5},utils_layout.map(row=>{return row.map(input=>{return/*#__PURE__*/react.createElement(Grid.GridItem,(0,esm_extends/* default */.Z)({key:input.name},input.size),/*#__PURE__*/react.createElement(build.GenericInput,(0,esm_extends/* default */.Z)({},input,{disabled:isDisabled,error:errors[input.name],onChange:handleChange,value:values[input.name]})));});}))))),/*#__PURE__*/react.createElement(Box.Box,null,/*#__PURE__*/react.createElement(Typography.Typography,{variant:"beta",as:"h2"},formatMessage({id:'global.roles',defaultMessage:"User's role"})),/*#__PURE__*/react.createElement(Box.Box,{paddingTop:4},/*#__PURE__*/react.createElement(Grid.Grid,{gap:5},/*#__PURE__*/react.createElement(Grid.GridItem,{col:6,xs:12},/*#__PURE__*/react.createElement(SelectRoles/* default */.Z,{disabled:isDisabled,error:errors.roles,onChange:handleChange,value:values.roles})),roleSettingsForm.map(row=>{return row.map(input=>{return/*#__PURE__*/react.createElement(Grid.GridItem,(0,esm_extends/* default */.Z)({key:input.name},input.size),/*#__PURE__*/react.createElement(build.GenericInput,(0,esm_extends/* default */.Z)({},input,{disabled:isDisabled,onChange:handleChange,value:values[input.name]})));});})))))),/*#__PURE__*/react.createElement(ModalLayout.ModalFooter,{startActions:/*#__PURE__*/react.createElement(Button.Button,{variant:"tertiary",onClick:onToggle,type:"button"},formatMessage({id:'app.components.Button.cancel',defaultMessage:'Cancel'})),endActions:endActions}));}));};ModalForm.propTypes={onToggle:(prop_types_default()).func.isRequired,queryName:(prop_types_default()).array.isRequired};/* harmony default export */ const ListPage_ModalForm = (ModalForm);
